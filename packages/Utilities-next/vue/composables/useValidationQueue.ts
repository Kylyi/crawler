...
type ValidationProcessByFieldInput = Record<string, [() => void, timeoutMs?: number] | (() => void)>

export type ValidationProcessByField = Record<string, Array<[() => void, timeoutMs?: number]>>
 ...
 */
export function useValidationQueue(_validationProcessByField: ValidationProcessByFieldInput = {}) {
  const validationProcessByField = inject(validationQueueKey, ref<ValidationProcessByField>({}))
