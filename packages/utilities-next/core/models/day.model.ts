...
export class Day {
  ...
  get isToday() {
    ...
    const dateTime = this.dateObj.year() * 31556926 + this.dateObj.month() * 2629743 + this.dateObj.date() * 86400
  ...
  constructor(
    ...
    this.isNotCurrent = !this.dateObj.isBetween(period.periodStart, period.periodEnd, 'd', '[]')
